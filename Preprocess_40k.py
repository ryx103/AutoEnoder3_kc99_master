...
def process_file(path, filename, data_encoding):
    ...
    if len(data) > 5000:
        data = data.sample(n=5000, random_state=2023)  # You can change the random_state for different random samples
    else:
        print("Dataset contains fewer than 5000 rows; using full dataset.")
